...
class Pay
{
	...
	public function simplePay()
	{
		...
		$receiver[0]->email = "abc@paypal.com";
		...
		$payRequest = new PayRequest($requestEnvelope, "PAY", "http://localhost/cancel", "USD", $receiverList, "http://localhost/return");
	...
	public function chainPay()
	{
		...
		// A receiver's email address
		$receiver[0]->email = "enduser_biz@gmail.com";
		...
		// A receiver's email address
		$receiver[1]->email = "xyz@paypal.com";
